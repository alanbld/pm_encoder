...
exports.wasm_get_lenses = wasm_get_lenses;
 ...
 * @returns {string}
 */
function wasm_serialize(json_files, json_config) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.wasm_serialize = wasm_serialize;

/**
 * Get library version (WASM)
 * @returns {string}
 */
function wasm_version() {
    let deferred1_0;
    let deferred1_1;
    try {
...
exports.wasm_version = wasm_version;
...
const wasmPath = `${__dirname}/pm_encoder_bg.wasm`;
